    ...
    <section id="projects" className="mx-16 md:mx-32 lg:mx-48 xl:mx-64 mt-5">
      ...
      <div className="flex justify-around flex-col xl:flex-row">
        <div className="basis-2/5">
          <a href="https://github.com/zeapoz/chip8" className="hover:text-white">
          ...
          <p>
            ...
            <a href="https://en.wikipedia.org/wiki/CHIP-8" className="hover:text-white font-bold">
        ...
        <div className="basis-2/5">
          <a href="https://zeapoz.github.io/" className="hover:text-white">
            <img src="https://img.icons8.com/ios-filled/24/969696/link--v1.png" className="inline" />
          ...
          <p>
            ...
            <a href="https://en.wikipedia.org/wiki/2048_(video_game)" className="hover:text-white font-bold">
              2048
            </a>
